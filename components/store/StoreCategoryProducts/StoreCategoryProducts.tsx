...
const AllCategoriesGrid = lazy(() => import('../AllCategoriesGrid').then(m => ({ default: m.AllCategoriesGrid })));
...
<div className="flex items-center gap-2">
  ...
  <button onClick={() => setMobileFilter(true)} className="lg:hidden flex items-center gap-2 px-3 py-2 bg-gray-100 rounded-lg text-sm font-medium text-gray-700 hover:bg-gray-200 transition">
    ...
    <span>Filters</span>
      ...
      <div className="flex-1"><div className="max-w-[1408px] mx-auto px-4 sm:px-6 lg:px-8 py-6"><div className="flex gap-6">
