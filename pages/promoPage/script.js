...
function initFeatureTabs() {
    ...
    const featuresData = {
        all: [
            ...
            { icon: 'speed', title: 'সুপার-ফাস্ট 0.5s লোড টাইম', desc: 'মাত্র ০.৫ সেকেন্ডে লোড হয়ে সেরা ইউজার অভিজ্ঞতা নিশ্চিত করবে।' },
...
function initChat() {
    ...
    const responses = {
        ...
        'Gadget Theme': '👋গেজেট থিম দেখার জন্য এই লিংকে যান gadget.systemnextit.com'
    };
