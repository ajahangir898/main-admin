    ...
    <div className="space-y-8 animate-fade-in p-6 max-w-6xl mx-auto">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          ...
          <p className="text-gray-500 mt-1">Manage your subscription plan and billing details</p>
        </div>
        <button
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
          ...
          <div className="p-6">
            <div className="flex items-center justify-between mb-4">
              <div className={`w-12 h-12 rounded-xl bg-gradient-to-br ${currentPlan.color} flex items-center justify-center text-white`}>
                {currentPlan.icon}
              </div>
              <span className={`px-3 py-1 rounded-full text-xs font-semibold ${statusStyle.bg} ${statusStyle.text} flex items-center gap-1.5`}>
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
          <div className="flex items-center justify-between mb-4">
            <div className={`w-12 h-12 rounded-xl bg-gradient-to-br ${daysLeft <= 7 ? 'from-red-500 to-orange-500' : 'from-violet-500 to-purple-500'} flex items-center justify-center text-white`}>
              <Clock size={24} />
            </div>
            {daysLeft <= 7 && (
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-gradient-to-br from-violet-500 to-purple-600 rounded-2xl p-6 text-white relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <button
              onClick={onUpgrade}
              className="w-full py-3 px-4 bg-white text-violet-600 rounded-xl font-semibold text-sm hover:bg-gray-50 transition-all flex items-center justify-center gap-2"
            >
              View Plans
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">Your recent transactions and invoices</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
        <div className="flex items-center justify-between mb-6">
          ...
          <button className="px-4 py-2 text-sm font-medium text-blue-600 bg-blue-50 rounded-xl hover:bg-blue-100 transition-all">
            Add Method
          </button>
        </div>
        ...
        <div className="p-4 rounded-xl border-2 border-dashed border-gray-200 text-center">
          ...
          <p className="text-sm text-gray-500">No payment method added yet</p>
