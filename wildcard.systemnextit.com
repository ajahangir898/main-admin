...
server {
    listen 80;
    server_name systemnextit.com *.systemnextit.com cartnget.shop *.cartnget.shop shopbdit.com *.shopbdit.com;
...
# HTTPS - shopbdit.com with Cloudflare Origin SSL
server {
    listen 443 ssl;
    server_name shopbdit.com *.shopbdit.com;

    ssl_certificate /etc/ssl/cloudflare/shopbdit.com/cert.pem;
    ssl_certificate_key /etc/ssl/cloudflare/shopbdit.com/key.pem;
